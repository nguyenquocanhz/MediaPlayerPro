...
object Loc {
    ...
    val xxnapiBottomTab get() = get("XXNAPI", "XXNAPI", "XXNAPI")
    val spankbangBottomTab get() = get("SpankBang", "SpankBang", "SpankBang")
    val recentVideosSubTab get() = get("GẦN ĐÂY", "RECENT", "最近播放")
